package pers.lzy.template.excel.test.messy;
...
public class MessyTest {
    ...
    public void test() throws IOException, InvalidFormatException {
        ...
        //获取文件的URL
        URL url = this.getClass().getClassLoader().getResource("07MyScore_messy.xlsx");
        assert url != null;
        ...
        // 将Excel 写出去，查看结果
        ExcelUtil.writeFile(workbook, new File("C:\\Users\\immort\\Desktop\\fff\\07MyScore_messy11111.xlsx"));
    }
