package pers.lzy.template.excel.test.calculate;
...
public class CalculateTest {
    ...
    public void test() throws IOException, InvalidFormatException {
        ...
        //获取文件的URL
        URL url = this.getClass().getClassLoader().getResource("04MyScore_calculate.xlsx");
        assert url != null;
        ...
        // 将Excel 写出去，查看结果
        ExcelUtil.writeFile(workbook, new File("C:\\Users\\immortal\\Desktop\\04MyScore_calculatexxxx.xlsx"));
    }
