package pers.lzy.template.excel.test.align;
...
public class AlignTest {
    ...
    public void test() throws IOException, InvalidFormatException {
        ...
        //获取文件的URL
        URL url = this.getClass().getClassLoader().getResource("06MyScore_align.xlsx");
        assert url != null;
        ...
        // 将Excel 写出去，查看结果
        ExcelUtil.writeFile(workbook, new File("C:\\Users\\immort\\Desktop\\fff\\06MyScore_align1111.xlsx"));
    }
